...
File: Bread.java
Program Description:
Bread class. Represents a consumable food item in the game.
...
public class Bread extends Food { // Bread class extends Food base class

    public Bread(gamePanel gp) { // Constructor receives reference to game panel
        super(gp); // Call to superclass constructor
        
        name = "Bread"; // Set the item name
        ...
        try { // Load and scale the item image
            image = gp.uTool.scaleImage(
                        javax.imageio.ImageIO.read(getClass().getResourceAsStream("/items/Bread.png")), 
                        sizeX, 
                        sizeY
