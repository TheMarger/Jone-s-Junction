...
File: save3.java
Program Description:
Save slot 3 class. Handles saving and loading game state to save3.dat file.
...
import java.io.*; // import file I/O and serialization utilities (File, FileInputStream, Object streams, etc.)
...
public class save3 { // save3 class: handles the third save slot (save3.dat)

    private static final String SAVE_FILE = "save3.dat"; // file name used for this save slot
